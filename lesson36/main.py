...
find or search sub - show data of all users with sub in name or phone or birthday
...
def clear_all(contacts, *args):
    yes_no = input(f'Are you sure you want to delete the all contacts? (Y/n)')
    if yes_no == 'Y':
        contacts.clear()
        return f'AdressBook in empty'
    else:
