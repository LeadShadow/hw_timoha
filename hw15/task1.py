...
# email пользователя. Вам необходимо случайным образом отобрать некое количество победителей
# розыгрыша.
#
# Создайте функцию get_random_winners(quantity, participants), которая будет возвращать список
# уникальных идентификаторов базы данных из словаря participants количеством quantity. Это будет
# список победителей
#
# Требования:
#
