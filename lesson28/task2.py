...
# Создайте функцию discount_price(discount), которая будет определять в себе и возвращать функцию
# расчета реальной цены с учетом скидки.
#
# Вызов функции discount_price(discount) вернет функцию, которая рассчитывает цену на товар со
# скидкой равной discount .
#
# Например:
#
